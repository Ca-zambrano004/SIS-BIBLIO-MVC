...
<div class="container-fluid" >
	<form class="well FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="row">
				<input class="form-control" type="hidden" name="eliminar_busqueda_general_libro" value="1">
				<div class="col-xs-12">
					<p class="text-center">
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			require_once "./controladores/librosControlador.php";
				...
				echo $insLibros->crud_mostrar_libros_controlador($pagina[1],3,$_SESSION["privilegio_sbp"],$_SESSION["codigo_cuenta_sbp"],$_SESSION["busqueda_libro"]);
			?>		
		</div>
	</div>
</div>
