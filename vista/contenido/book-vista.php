...
<div class="container-fluid">
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form action="<?php echo SERVERURL; ?>ajax/librosAjax.php" method="POST" data-form="save" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
				<fieldset>
					...
					<div class="container-fluid">
						...
						<div class="col-xs-12 col-sm-6">
						    	<div class="form-group label-floating">
								  	...
								  	<input pattern="[a-zA-Z0-9- ]{1,30}" class="form-control" type="text" name="codigo-reg" required="" maxlength="16">
								</div>
						</div>
							<div class="col-xs-12 col-sm-6">
						    	<div class="form-group label-floating">
		    				...
		    				<div class="col-xs-12 col-sm-6">
						    	<div class="form-group label-floating">
								  	...
								  	<input pattern="[0-9]" class="form-control" type="date" name="year-reg" maxlength="">
								</div>
		    				</div>
		    				<div class="col-xs-12 col-sm-6">
						    	<div class="form-group label-floating">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
								  	...
								  	<select id= "empresa-reg" name="empresa-reg" class="form-control">
								  		<?php  
								  		require_once "./controladores/empresaControlador.php";
								  			$insEmp= new empresaControlador();

								  			$datosEmp=$insEmp->datos_empresa_controlador("select",0);
								  			
								  			while($numEmpr=$datosEmp->fetch()){
								  				echo '
								  				<option value="'.($numEmpr['EmpresaCodigo']).'"> '.$numEmpr['EmpresaNombre'].'
								  				</option>
								  					';
								  			}
								  		?>	
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
								  	...
								  	<select id= "categoria-reg" name="categoria-reg" class="form-control">
							          	<?php  
								  		require_once "./controladores/categoriaControlador.php";
								  			$insCat= new categoriaControlador();

								  			$datosCat=$insCat->datos_categoria_controlador("select",0);
								  			
								  			while($numcat=$datosCat->fetch()){
								  				echo '
								  				<option value="'.($numcat['CategoriaCodigo']).'"> '.$numcat['CategoriaNombre'].'
								  				</option>
								  					';
								  			}
								  		?>
		    				...
		    				<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
								  	...
								  	<select id= "proveedor-reg" name="proveedor-reg" class="form-control">
							          		<?php  
									  		require_once "./controladores/proveedorControlador.php";
									  			$insProve= new proveedorControlador();

									  			$datosProve=$insProve->datos_proveedor_controlador("select",0);
									  			
									  			while($numProv=$datosProve->fetch()){
									  				echo '
									  				<option value="'.($numProv['ProveedorCodigo']).'"> '.$numProv['ProveedorNombre'].'
									  				</option>
									  					';
									  			}
									  		?>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6">
						    	<div class="form-group label-floating">
								  	...
								  	<input pattern="[0-9- ]{1,7}" class="form-control" type="tel" name="precio-reg" maxlength="7">
								</div>
		    				</div>
		    				<div class="col-xs-12 col-sm-6">
						    	<div class="form-group label-floating">
								  	<label class="control-label"># Paginas</label>
								  	<input pattern="[0-9- ]{1,5}" class="form-control" type="tel" name="paginas-reg" maxlength="5">
								</div>
		    				</div>
		    				<div class="col-xs-12">
						    	<div class="form-group label-floating">
								  	<label class="control-label">Ubicación</label>
								  	<input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ- ]{1,30}" class="form-control" type="text" name="ubicacion-reg" maxlength="14">
								</div>
		    				</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group label-floating">
								  	...
								  	<textarea name="resumen-reg" class="form-control" rows="7"></textarea>
								</div>
		    				</div>
						</div>
					</div>
...
<!--
 ...
 -->
			    ...
			    <p class="text-center" style="margin-top: 20px;">
			    	<button type="submit" name="enviar" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Guardar</button>
			    </p>
