<?php 
	...
	class administradorModelo extends mainModel{
		...
		//CREACION DEL MODELO DE AGREGAR LOS ADMINISTRADORES
		protected function agregar_administrador_modelo ($datos){
			$sql=mainModel::conectar()->prepare("INSERT INTO admin (AdminCC,AdminNombre,AdminApellido,AdminTelefono,AdminDireccion,CuentaCodigo) VALUES (:CC,:Nombre,:Apellido,:Telefono,:Direccion,:Codigo)");
		...
		//CREACION DEL MODELO DE ELIMINAR LOS ADMINISTRADORES
		...
		//CREACION DEL MODELO DE DATOS DE LOS ADMINISTRADORES
		...
		//CREACION DEL MODELO ACTUALIZAR DATOS DE LOS ADMINISTRADORES
		protected function actualizar_administrador_modelo($datos){
		$query=mainModel::conectar()->prepare("UPDATE admin SET AdminCC=:CC, AdminNombre=:Nombre, AdminApellido=:Apellido, AdminTelefono=:Telefono, AdminDireccion=:Direccion WHERE CuentaCodigo=:Codigo");
