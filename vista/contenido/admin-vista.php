...
<div class="container-fluid">
	...
	<p class="lead">El presente modulo permitira cargar los sumarios del personal que hara uso administrativo del sistema, de acuerdo a los niveles de privilegios que lo ameriten.</p>
</div>
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form action="<?php echo SERVERURL; ?>ajax/administradorAjax.php" method="POST" data-form="save" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
		    	...
		    	<fieldset>
					<legend><i class="zmdi zmdi-attachment-alt"></i> &nbsp; Imágen y Genero</legend>
					<div class="col-xs-12">
