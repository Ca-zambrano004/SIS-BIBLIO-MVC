			...
			<div class="row">
				<div class="col-xs-12 col-md-8 col-md-offset-2">
					<div class="form-group label-floating">
						...
						<input class="form-control" type="text" name="busqueda_cliente_inicial" required="">
					</div>
				</div>
				<div class="col-xs-12">
					<p class="text-center">
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			require_once "./controladores/clienteControlador.php";
				...
				echo $insCliente->crud_cliente_controlador($pagina[1],3,$_SESSION["privilegio_sbp"],$_SESSION["busqueda_cliente"]);
			?>
		</div>
	</div>
</div>
