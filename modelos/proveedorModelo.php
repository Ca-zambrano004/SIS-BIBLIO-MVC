...
class proveedorModelo extends mainModel{
	...
	//CREACION DEL MODELO DE AGREGAR Proveedor
	protected function agregar_proveedor_modelo ($datos){
		...
		//CREACION DEL MODELO DE DATOS DEL PROVEEDOR
	...
	//CREACION DEL MODELO DE ELIMINAR PROVEEDOR
	...
	//CREACION DEL MODELO ACTUALIZAR DATOS DEL PROVEEDOR
